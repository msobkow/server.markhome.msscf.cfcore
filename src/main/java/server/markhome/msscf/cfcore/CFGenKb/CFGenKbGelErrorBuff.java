// Description: Java 11 implementation of a GelError buffer object.
...
public class CFGenKbGelErrorBuff
	extends CFGenKbGelBoilerplateBuff
		...
		Serializable
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof CFGenKbGelErrorBuff ) {
			CFGenKbGelErrorBuff rhs = (CFGenKbGelErrorBuff)obj;
	...
	public void set( CFGenKbGelInstructionBuff src ) {
		if( src instanceof CFGenKbGelErrorBuff ) {
			setGelErrorBuff( (CFGenKbGelErrorBuff)src );
		}
		else {
	...
	public void setGelErrorBuff( CFGenKbGelErrorBuff src ) {
		super.setGelBoilerplateBuff( src );
	}
}
