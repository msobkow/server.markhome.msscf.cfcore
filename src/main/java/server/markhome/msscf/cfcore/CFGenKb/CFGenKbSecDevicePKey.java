	...
	public int compareTo( Object obj ) {
		if( obj == null ) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"CFGenKbSecDevicePKey, CFGenKbSecDeviceBuff" );
		}
	}

	public String toString() {
		String ret = "<CFGenKbSecDevicePKey"
