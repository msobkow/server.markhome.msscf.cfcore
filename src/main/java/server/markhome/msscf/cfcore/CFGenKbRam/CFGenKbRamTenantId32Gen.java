...
/*
 *	CFGenKbRamTenantId32Gen RAM 32-bit Id Generator for Tenant
 */
public class CFGenKbRamTenantId32Gen
		...
		Serializable
{
	...
	public CFGenKbRamTenantId32Gen() {
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof CFGenKbRamTenantId32Gen ) {
			CFGenKbRamTenantId32Gen rhs = (CFGenKbRamTenantId32Gen)obj;
	...
	public int compareTo( Object obj ) {
		if( obj == null ) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"obj",
				obj,
				"CFGenKbTenantId32Gen" );
		}
	}

	public String toString() {
		String ret = "<CFGenKbTenantId32Gen"
